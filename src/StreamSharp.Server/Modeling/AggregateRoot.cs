...
//        if (method == null)
//        {
//            var constructor = type.GetConstructor(BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public, [typeof(TId)]);
...
//    /// <summary>
//    /// Loads an aggregate of <typeparamref name="TAggregate"/> from a <see cref="EventStream{TId}" />.
//    /// </summary>
//    /// <typeparam name="TAggregate"></typeparam>
//    /// <typeparam name="TId"></typeparam>
//    /// <param name="events">The stream of events.</param>
//    /// <returns>A instance of <typeparamref name="TAggregate"/>.</returns>
//    public static TAggregate LoadFromHistory<TAggregate>(EventStream events)
//        where TAggregate : AggregateRoot
//    {
//        var aggregate = Create<TAggregate>();
...
{
    private EventStream _events = EventStream.Create();
    ...
    public void LoadFromHistory(EventStream events)
    {
        _events = events;
